...
def ensemble_votoMajor(path_model, k, CATEGORIES, X_test,y_test, save_dir):
  model_1 = load_model(path_model + '/0_DenseNet201_BD_ALL1_10/bestLoss_model_' + str(k) + '.h5')
  model_2 = load_model(path_model + '/1_MobileNet_BD_ALL1_10/bestLoss_model_' + str(k) + '.h5')
...
if __name__=="__main__":
  ...
  _base = 'BD_ALL1'
  _path_BASE = r"C:\Users\jczarsGamer\anaconda3\QUALIFICA\BD_JOIN\BD_ALL1_R"
  _path_MODEL = r"C:\Users\jczarsGamer\anaconda3\QUALIFICA\BD_JOIN_COMMITE\rel_pro_BD_ALL1_K10B200_120124"
  #_path_CATEGORIES = r"C:\Users\jczarsGamer\anaconda3\QUALIFICA\BD_JOIN\BD_ALL1_R/Test/k1"
  CATEGORIES =['1.Thymbra','2.Erica','3.Castanea','4.Eucalyptus','5.Myrtus','6.Ceratonia','7.Urginea','8.Vitis','9.Origanum','10.Satureja','11.Pinus','12.Calicotome','13.Salvia','14.Sinapis','15.Ferula','16.Asphodelus','17.Oxalis','18.Pistacia','19.Ebenus','20.Olea','acrocomia_aculeta','anadenanthera_colubrina','arachis_sp','archontophoenix_cunninghamiana','arecaceae','arrabidaea_florida','aspilia_grazielae','bacopa_australis','brugmansia_suaveolens','caesalpinia_peltophoroides','caryocar_brasiliensis','cecropia_pachystachya','ceiba_speciosa','chromolaena_laevigata','cissus_campestris','cissus_spinosa','combretum_discolor','cordia_trichotoma','cosmos_caudatus','croton_urucurana','dianella_tasmanica','dipteryx_alata','doliocarpus_dentatus','erythrina_mulungu','eucalyptus_sp','faramea_sp','genipa_auniricana','gomphrena_sp','guazuma_ulmifolia','hortia_oreadica','hyptis_sp','ligustrum_lucidum','luehea_divaricata','mabea_fistulifera','machaerium_aculeatum','magnolia_champaca','manihot_esculenta','matayba_guianensis','mauritia_flexuosa','mimosa_ditans','mimosa_pigra','mitostemma_brevifilis','myracroduon_urundeuva','myrcia','myrcia_guianensis','ochroma pyramidale','ouratea_hexasperma','pachira_aquatica','passiflora_gibertii','paullinia_spicata','piper_aduncum','poaceae_sp','protium_heptaphyllum','qualea_multiflora','ricinus_communis','schinus_sp','schizolobium_parahyba','senegalia_plumosa','serjania_erecta','serjania_hebecarpa','serjania_laruotteana','serjania_sp','sida_cerradoensis','solanum_sisymbriifolium','syagrus','syagrus_romanzoffiana','symplocos_nitens','tabebuia_chysotricha','tabebuia_rosealba','tapirira_guianensis','tradescantia_Pallida','trema_micrantha','trembleya_phlogiformis','tridax_procumbens','vochysia_divergens','zea_mays']
  save_dir = r"C:\Users\jczarsGamer\anaconda3\QUALIFICA\BD_JOIN_COMMITE\BDALL1_k10b200_MbDn_Or_210124"
